<x-portal-reserva-shell
    title="Elige el deporte"
    :step="1"
    :back-href="route('portal.reservar.index')"
...
>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        @forelse ($deportes as $deporte)
            <a href="{{ route('portal.reservar.turno', [
                    'sede' => $sede->id,
                ...
                <div class="p-4 flex items-center justify-between gap-2">
                    ...
                    <span class="inline-flex items-center gap-1.5 text-sm font-bold text-emerald-800">
                        Ver turnos
        ...
        @empty
            <div class="sm:col-span-2 lg:col-span-3 xl:col-span-4 bg-white rounded-2xl border border-slate-200 p-10 text-center">
                ...
                <a href="{{ route('portal.reservar.index') }}" class="inline-flex mt-5 px-5 py-2.5 rounded-xl bg-emerald-700 text-white text-sm font-bold">
                    Volver a sedes
                </a>
            </div>
        @endforelse

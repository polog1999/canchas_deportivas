...
class OracleService
{
    ...
    public function  insertarEnOracle(string $grupo, string $codigo, string $codcontrib, float $monto, int $purchaseNumber,int $idTransaccion, Carbon $fechaYHoraPago, string $numeroLiquidacion)
    {
